...
const SceneCanvas = ({ selection, editMode, polygons, container }) => {
        ...
        >
            ...
            {!editMode && (
                <MoveableHelper
                    ...
                    onSelectionChange={(id) => polygonSelection.setValue(id)}
                />
            )}

            {editMode && (
                <SVGEditor container={imageSize} polygon={editablePolygon} />
            )}
        </div>
    );
};
